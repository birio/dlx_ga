...
trues_l  = [True]  * weights.numb_of_regs_to_use 
falses_l = [False] * (32 - weights.numb_of_regs_to_use)
...
print "num_of_labels "
print num_of_labels
print "labels_lines_l "
print labels_lines_l
print labels_lines_l.__len__()
...
for i in range (0, number_of_lines):
   ...
   if str(asm_line[0]) in opcodes.r_types_l:
      ...
      if (asm_line[0] == "slti") or (asm_line[0] == "sltiu"):
         imm = random.choice(weights.imm_value_15_l)
      else:
         imm = random.choice(weights.imm_value_16_l)
      line = str(asm_line[0]) + "\t $" + str(r0) + ",\t $" + str(r1) + ",\t " + str(imm)

   elif str(asm_line[0]) in opcodes.s_i_types_l:
      r0 = random.choice(available_regs_l)
      r1 = random.choice(available_regs_l)
      imm = random.choice(weights.imm_value_5_l)
      line = str(asm_line[0]) + "\t $" + str(r0) + ",\t $" + str(r1) + ",\t " + str(imm)
